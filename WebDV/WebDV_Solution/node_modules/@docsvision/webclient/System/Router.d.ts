...
export declare class Router implements IRouter, ILegacyRouter, IRouterNavigation {
    ...
    constructor(services: $SearchPanel & $EnableRouterLogging & $LayoutManager);
    ...
    AddMainContentChangingListener(listener: (isClear?: boolean) => JQueryDeferred<any>): void;
    /** Отменяет регистрацию подписчика на событие изменения основного содержимого. */
    RemoveMainContentChangingListener(listener: (isClear?: boolean) => JQueryDeferred<any>): void;
